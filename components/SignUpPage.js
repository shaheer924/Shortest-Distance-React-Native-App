    ...
    <ScrollView>
      <Box alignItems="center" marginTop={"2/5"}>
        <Box maxW="80" rounded="lg" overflow="hidden" borderColor="coolGray.200" borderWidth="1" _dark={{
            ...
            <AspectRatio w="100%" ratio={16 / 9}>
              ...
              <Box>
                <Heading size="md" ml="25" mr="25" mt="55" textAlign={"center"}>
                  Please add your credentials to sign up
                </Heading>
              </Box>
            </AspectRatio>
          </Box>
          ...
          <Box alignItems="center" mb="25" ml="5" mr="5">
            <Input mx="3" placeholder="Enter your mobile number" w="100%" type='password' disabled={disabled} onChangeText={(e => setPassword(e))} />
          </Box>
          <Box alignItems="center" mb="25">
            <Button disabled={disabled} onPress={handleSignUp}>{disabled == true ? <Spinner color="emerald.500" /> : "Sign up"}</Button>
          </Box>
        </Box>
      </Box>
    </ScrollView>
